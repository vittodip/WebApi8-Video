...
namespace WebApi8_Video.Controllers
{
    ...
    public class AutorController : ControllerBase
    {
        ...
        public async Task<ActionResult<ResponseModel<List<AutorModel>>>> CriarAutor(AutorCriacaoDto aurtorCriacaoDto)
        {
            var autores = await _autorInterface.CriarAutor(aurtorCriacaoDto);
            return Ok(autores);
        }
